  ...
  generate for (genvar i = 0; i < NUM_INTF; i++) begin
    ...
    if (NUM_QDMA > 1) begin
      ...
      axi_stream_pipeline tx_ppl_inst (
        ...
        .m_axis_tuser  (axis_adap_tx_250mhz_tuser),
        //.m_axis_tready (m_axis_adap_tx_250mhz_tready[i]),
        .m_axis_tready (s_axis_adap_rx_250mhz_tready[i]),
      ...
      axi_stream_pipeline rx_ppl_inst (
        ...
        // LOOPBACK the TX (adap_tx) to RX (adap_rx)
        .s_axis_tvalid (m_axis_adap_tx_250mhz_tvalid[i]),
        .s_axis_tdata  (m_axis_adap_tx_250mhz_tdata[`getvec(512, i)]),
        .s_axis_tkeep  (m_axis_adap_tx_250mhz_tkeep[`getvec(64, i)]),
        .s_axis_tlast  (m_axis_adap_tx_250mhz_tlast[i]),
        .s_axis_tuser  (axis_adap_tx_250mhz_tuser),
        .s_axis_tready (s_axis_adap_rx_250mhz_tready[i]),
