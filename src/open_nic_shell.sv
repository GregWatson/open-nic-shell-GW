...
ddr4_0 ddr4_0_inst(
  ...
  .c0_sys_clk_p(clk_in1_p),                               // input wire c0_sys_clk_p
  .c0_sys_clk_n(clk_in1_n),                               // input wire c0_sys_clk_n
  ...
  .sys_rst(ddr4_sys_rst)                                  // input wire sys_rst
);
